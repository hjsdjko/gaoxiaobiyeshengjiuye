...
public class MianshishenqingView extends MianshishenqingEntity implements Serializable {
	...
	*/
	...
	private String mianshishenqingYesnoValue;
	...
	* 获取： 申请状态的值
	*/
	public String getMianshishenqingYesnoValue() {
		return mianshishenqingYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setMianshishenqingYesnoValue(String mianshishenqingYesnoValue) {
		this.mianshishenqingYesnoValue = mianshishenqingYesnoValue;
	}
	...
	public String toString() {
		return "MianshishenqingView{" +
			", mianshishenqingYesnoValue=" + mianshishenqingYesnoValue +
